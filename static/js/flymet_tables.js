  ...
  "columnDefs": [
    {className: "dt-center", "targets":"_all"},
    {
      ...
      "createdCell": function (td, cellData, rowData, row, col) {
        $td = $(td);
        //find the table heaers with class=data
        var $th = $td.closest('table').find('th.data').eq($td.index());
...
//This will his all the tables under a certain form and show the first by default.
